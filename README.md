...
| 기능 | 동작 |상세내용|
| :-----: | :---------: |:---:|
|  가입 |   <img src="https://github.com/kr-JSW/blog-FE/assets/150055151/f15bb5ca-3612-4979-944b-e0e964f5f4d5" width="500"/>    |가입 코드가 있어야지 가입이 가능합니다.<br/> 가입코드는 Conact Me를 통해 개발자에게 요청 할 수 있습니다. |
|  로그인, 프로필 변경, 패스워드 변경 |    <img src="https://github.com/kr-JSW/blog-FE/assets/150055151/1c4d9d0f-e0eb-4e82-a318-b70a7f161295" width="500"/>   |로그인 후, mypage로 들어가서 프로필 사진과 패스워드 변경이 가능합니다. <br/> mypage의 기능구성은 일반유저냐 혹은 관리자냐에 따라서 다르게 나타납니다. |
|  유저관리 및 코드관리 |    <img src="https://github.com/kr-JSW/blog-FE/assets/150055151/f7b5431f-e922-4a0c-86cd-e235c2fee5f0" width="500"/>   |관리자 계정으로 로그인을 하게되면, 유저관리 및 가입코드관리탭이 나타나게 됩니다. <br/> 여기서 유저관리에서 유저의 등급 조정 및 탈퇴가 가능합니다. <br/> 가입코드관리에서는 코드발급 및 삭제,복사가 가능하며, 유저가 해당 가입코드로 가입을 하게되면, 코드는 자동으로 삭제됩니다.|
|  카테고리 생성 및 삭제 |    <img src="https://github.com/kr-JSW/blog-FE/assets/150055151/fbdfee2e-38cd-4941-9f22-72154489b4bb" width="500"/>   |관리자 계정의 mypage에서 카테고리의 생성 및 삭제가 가능합니다.<br/>카테고리의 이름과 배경화면을 이미지URL 및 PC에서 업로드 할 수 있으며, 카테고리를 삭제하게되면, 카테고리에 해당하는 모든 게시글이 삭제됨과 동시에 서버에 저장했던 이미지 파일도 같이 삭제됩니다.|
|  CONACT ME |    <img src="https://github.com/kr-JSW/blog-FE/assets/150055151/b02e1a50-c2b2-4c3d-821d-c78454808c4f" width="500"/>   |EmailJs를 이용하여 로그인 없이 제 구글 계정에 메일을 전송 할 수 있습니다. 공유형 블로그의 컨셉에 맞게 가입사유와 코드를 요청하면, 심사 후 가입코드를 전달해드립니다. 가입 목적 이 외의 문의도 동일하게 전달가능합니다.|
...
프로젝트를 다 끝내고 나서 당시의 내 생각이 정말 바른 생각이었는지 확인하기 위해서, 웹 상으로 자문을 구하고 나름대로 정보를 찾고나서 고민을 하고나서 내린 결론은 좋은 경험이기는 하지만, 웹 성능상의 관점으로 보았을때는
...
이 부분은 정말 아쉬웠다.
<br/>
- 원래 내가 생각했던 계획은 프론트는 vercel로 호스팅을하고, 백엔드는 쓰지않는 스마트폰에 리눅스를 설치하여, 간이 서버로 만들자! 였다. 그렇게되면 랩탑처럼 전원선을 계속 달고있을 필요도 없고, 호스팅 비용도 들지않기 때문이었다. 거기다가 애초에 내가 계획했던 기능중, 게시글의 썸네일로 이미지파일을 서버에 저장하는 것도 있으니, 저장공간은 덤이었다.<br/>
...
구글에서 제시하는 해결법을 적용하면, 다음 오류가 곧이어 나타났고, 그 문제를 해결하려하니 모바일 리눅스에서의 오류가 나타나길 반복했다. <br/>
